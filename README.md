# ![nf-core/magmap](docs/images/nf-core-magmap_logo_light.png#gh-light-mode-only) ![nf-core/magmap](docs/images/nf-core-magmap_logo_dark.png#gh-dark-mode-only)
...
**nf-core/magmap** is a bioinformatics best-practice analysis pipeline for best-practice analysis pipeline for mapping reads to a (large) collections of genomes.
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```console
    nextflow run nf-core/magmap -profile test,YOURPROFILE
    ```
